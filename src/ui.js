...
export function setupUI(sim) {
    ...
    const infoData = {
        ...
        gwradiation: { title: 'Quadrupole Radiation', body: 'Gravitational wave emission from the mass quadrupole moment: $P = \\frac{1}{5}|\\dddot{I}_{ij}|^2$. For circular binaries this gives $P = \\frac{32}{5} \\frac{m_1^2 m_2^2(m_1+m_2)}{r^5}$, causing orbital inspiral and merger \u2014 exactly what LIGO detects. Emitted gravitons (green) carry energy and momentum away from the system. Also includes EM quadrupole radiation when Radiation is enabled. Requires Gravity.' },
