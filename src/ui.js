...
export function setupUI(sim) {
    ...
    const infoData = {
        ...
        magnetic: { title: 'Magnetic Force', body: 'Dipole-dipole force: aligned \u22A5-to-plane dipoles repel (\u03BC\u2081\u03BC\u2082/r\u2074). Magnetic moment \u03BC = \u00BDq\u03C9r\u00B2 (uniform charge density sphere). Lorentz force from velocity-dependent B fields is handled by the Boris rotation.' },
        gravitomag: { title: 'Gravitomagnetic Force', body: 'Dipole force L\u2081L\u2082/r\u2074: co-rotating masses attract. Angular momentum L = (2/5)m\u03C9r\u00B2. Linear gravitomagnetism (co-moving masses attract, frame-dragging) is handled by the Boris rotation.' },
        spinorbit: { title: 'Spin-Orbit Coupling', body: 'Magnetic and gravitomagnetic fields exert torques on particle spin. EM torque \u03C4 = \u03BC\u00B7B drives spin; GM torque \u03C4 = L\u00B7Bg from gravitomagnetic fields. Both converted to angular acceleration via \u03C4/I.' },
